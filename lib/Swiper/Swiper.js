...
var _temp = function () {
	...
	__REACT_HOT_LOADER__.register(Swiper, 'Swiper', 'dev/mtui/swiper/Swiper.jsx');

	__REACT_HOT_LOADER__.register(SwiperItem, 'SwiperItem', 'dev/mtui/swiper/Swiper.jsx');

	__REACT_HOT_LOADER__.register(_default, 'default', 'dev/mtui/swiper/Swiper.jsx');
}();
