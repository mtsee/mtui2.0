    ...
    (0, _createClass3.default)(Tabs, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                other = (0, _objectWithoutProperties3.default)(_props, ['activeIndex', 'changeback', 'animate']);
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.children.length != 0 ? this.props.children.map(function (elem, index) {
                            return _react2.default.createElement(
                                'li',
                                { ref: 'tab_' + index, onClick: _this.changeTabs.bind(_this, index), key: index, className: "mt-tabs-tab" + (_this.state.activeIndex == index ? ' mt-tabs-tab-active' : '') },
                                elem.props.name
                            );
                        }) : null
                    ),
            ...
            var body = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.children.length != 0 ? this.props.children.map(function (elem, index) {
                        return _react2.default.createElement(
                            'div',
                            { key: index, className: "mt-tabs-item" + (_this.state.activeIndex == index ? ' mt-tabs-item-active' : '') },
                            elem.props.children
                        );
                    }) : null
                )
            ...
            if (this.props.type == 'top') {
                return _react2.default.createElement(
                    'div',
                    (0, _extends3.default)({ className: 'mt-tabs' }, other),
                    prevBtn,
                    nextBtn,
                    head,
                    body
                ...
                return _react2.default.createElement(
                    'div',
                    (0, _extends3.default)({ className: "mt-tabs clearfix mt-tabs-" + this.props.type }, other),
                    head,
                    body
                );
            }
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(Tabs, 'Tabs', 'dev/mtui/tabs/Tabs.jsx');

    __REACT_HOT_LOADER__.register(TabItem, 'TabItem', 'dev/mtui/tabs/Tabs.jsx');

    __REACT_HOT_LOADER__.register(_default, 'default', 'dev/mtui/tabs/Tabs.jsx');
}();
